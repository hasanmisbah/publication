            ...
            <form method="POST" action="{{ route('customers.store') }}">     
                  @csrf               
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="customer_name" class="form-control" id="name" placeholder="Customer Name">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="email" name="customer_email" class="form-control" id="email" placeholder="Customer Email">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="phone" name="customer_phone" class="form-control" id="phone" placeholder="Customer Phone Number">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <textarea name="customer_address" class="form-control" id="address" placeholder="Customer Address"></textarea>
                        </div>
                    </div>
